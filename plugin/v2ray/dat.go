...
func (g *geoIPDat) generateGeoIP(entry *lib.Entry) (*router.GeoIP, error) {
	...
	switch g.OnlyIPType {
	case lib.IPv4:
		if entryCidr, err = entry.MarshalText(lib.IgnoreIPv6); err != nil {
			return nil, err
		}
	case lib.IPv6:
		if entryCidr, err = entry.MarshalText(lib.IgnoreIPv4); err != nil {
			return nil, err
		}
	default:
		if entryCidr, err = entry.MarshalText(); err != nil {
			return nil, err
		}
	}
